-- Permite guardar de forma estable las opciones «—» de tipo y Palas de Playa.

alter table public.campeonatos alter column hay_palas_playa drop not null;
...
begin
    ...
    if v_ronda not in ('Octavos', 'Cuartos', 'Semifinales', 'Final') then
